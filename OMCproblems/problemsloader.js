$(function(){
  ...
  for(var ci=0; ci<Number(contests[0]); ci++){
    ...
    for(var i=0; i<7; i++){
      if(i == 0){
        r += "<td><a target='_blank' class='" + contestGroup + "-contest' href='https://onlinemathcontest.com/contests/" + c_name + "/'>" + c_name + "</a></td>";
      }else{
        ...
        r += "<a target='_blank' class = '" + p_class + "-diff' href='https://onlinemathcontest.com/contests/" + c_name + "/tasks/" + c_name + "_" + alpha + "'>" + c_name + "-" + alpha + "</a></span></td>";
      }
    }
